          ...
          <div className="pt-14">
            <div
              className={`flex justify-center items-center  gap-4 ${
                switching === 1 ? "hidden" : "flex"
              }`}
            >
              <button
                onClick={() => handleClickPage(1)}
                className={`flex justify-center items-center w-[44px] h-[44px] rounded-[50%] text-lg font-medium ${
                  page === 1 ? "bg-beige" : "bg-none"
                }`}
              >
                1
              </button>
            ...
            <div
              className={`flex justify-center items-center  gap-4 ${
                switching === 2 ? "hidden" : "flex"
              }`}
            >
              <button
                onClick={() => handleClickSwitching(2)}
                className={`flex justify-center items-center w-[44px] h-[44px] rounded-[50%] text-lg font-medium ${
                  switching === 2 ? "bg-beige" : "bg-none"
                }`}
              >
                &lt;
              </button>
